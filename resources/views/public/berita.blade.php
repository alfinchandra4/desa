...
@section('content')
<div class="berita_desa container">
    <p class="title">Berita Desa</p>
    <div class="row">
        @for ($i = 0; $i < 10; $i++) <div class="col-md-4">
            <div class="card">
                <img src="https://www.w3schools.com/html/img_chania.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <div class="card-date-created">20 July 2021</div>
                    <p class="text card-text">Some quick example text to build on the card title and make up the bulk of
